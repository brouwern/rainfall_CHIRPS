...
#   # rain.half._         total rainfall from Jan. 2016 - Jun. 2016 (first 6 months of previous year)
#   # rain.half.half      total rainfall from Jan. 2015 - Jun. 2015 & Jan. 2016 - Jun. 2016 (first 6 months of previous 2 years)
#   # rain._.half         total rainfall from Jan. 2015 - Jun. 2015 (first 6 months from 2 years ago)
...
# Fill first two columns with relevant info
...
## FIR: Rainfall in first six months of previous year (January-June)
```{r}
...
## F_SUM: Sum of total rainfall in first six months of current and previous year
```{r}
...
# F_PREV: Total rainfall from first six months of previous year
```{r}
